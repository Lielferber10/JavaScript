import { cell, playerMove, stats, runningGame, gameMode, gameLevel, modifyCell, modifyPlayerMove, modifyStats, modifyRunningGame, modifyGameMode, modifyGameLevel } from "../data/data.js";

import { computerChoosing } from "./cumputerMove.js";

import { randomInt, getOccurrence, getIndexesOf } from "./utilities.js";
